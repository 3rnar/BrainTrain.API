...
namespace BrainTrain.API.Helpers.Learnosity.Utilities
{
    public class JsonObject
    {
        ...
        public void set(string type, string key, Object value)
        {
            ...
            {
                case 0:
                    this.di.Add(key, (int)value);
                    break;
                case 1:
                    this.ds.Add(key, (string)value);
                    break;
                case 2:
                    this.dj.Add(key, (JsonObject)value);
                    break;
                case 3:
                    this.db.Add(key, (bool)value);
                    break;
                case 4:
                    this.da.Add(key, (JsonObject)value);
                    break;
                case 5:
                    this.dd.Add(key, (decimal)value);
                    break;
                case 6:
                    this.dt.Add(key, (JToken)value);
                    break;
            }
        }
